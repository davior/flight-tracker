...
function makeLog(id: number, distance: number, createdAt: string): ApiLoggedFlight {
  return {
    id,
...
describe("sortLoggedFlightsNearestFirst", () => {
  it("sorts by distance and then by newest first", () => {
    const sorted = sortLoggedFlightsNearestFirst([
      makeLog(1, 5, "2026-03-28T10:00:00Z"),
      makeLog(2, 2, "2026-03-28T09:00:00Z"),
      makeLog(3, 2, "2026-03-28T11:00:00Z"),
    ]);
