...
def serialize_aircraft_registry(
    ...
    return AircraftRegistryResponse(
        ...
        operator_icao=registry.operator_icao,
        operator_iata=registry.operator_iata,
        operator_callsign=registry.operator_callsign,
        owner=registry.owner,
        serial_number=registry.serial_number,
        year_built=registry.year_built,
        engines=registry.engines,
        icao_aircraft_type=registry.icao_aircraft_type,
